      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                Provider.of<Controle_tarefa>(context, listen: false).adicionar(_tarefaControle.text);
                Navigator.pop(context);
              },
      ...
      builder: (context, controle_tarefa, child) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            Modelo_tarefa modelo_tarefa = controle_tarefa.tarefas[index]; // Correção: use "Modelo_tarefa" ao invés de "Modelo_tarefa"
